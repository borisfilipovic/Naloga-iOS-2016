...
class TennisVC: UIViewController, MatchPitchProtocol {
    
    var vc:UIViewController?
    var sportTypeView:UIView?
    var drawFieldView:DrawTennisField?
    ...
    func initUIView(frame _frame: CGRect)->UIView?{
        ...
        drawFieldView = DrawTennisField(frame: CGRect(x: 0, y: 15, width: UIScreen.mainScreen().bounds.width, height: UIScreen.mainScreen().bounds.width * 0.4175))
