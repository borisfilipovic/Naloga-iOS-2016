...
//import UIKit
//
//class BasketballVC: UIViewController, MatchPitchProtocol {
//    
//    var vc:UIViewController?
//    var sportTypeView:UIView?
//    var drawFieldView:DrawBasketballField?
...
//        drawFieldView = DrawBasketballField(frame: CGRect(x: 0, y: 15, width: UIScreen.mainScreen().bounds.width, height: UIScreen.mainScreen().bounds.width * 0.42))
